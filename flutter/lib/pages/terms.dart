        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSection(
                context,
                l10n.gameRulesFairPlay,
                l10n.gameRulesFairPlayContent,
              ),
              const SizedBox(height: 24),
              _buildSection(
                context,
              ...
              _buildSection(
                context,
                l10n.userGeneratedContent,
                l10n.userGeneratedContentContent,
              ),
              const SizedBox(height: 24),
              _buildSection(
                context,
                l10n.serviceAvailability,
                l10n.serviceAvailabilityContent,
              ),
              const SizedBox(height: 24),
              _buildSection(
                context,
                l10n.accountTermination,
                l10n.accountTerminationContent,
              ),
              const SizedBox(height: 24),
              _buildSection(
                context,
                l10n.disclaimerWarranties,
                l10n.disclaimerWarrantiesContent,
              ),
              const SizedBox(height: 24),
              _buildSection(
                context,
                l10n.limitationLiability,
                l10n.limitationLiabilityContent,
              ),
              const SizedBox(height: 24),
              _buildSection(
                context,
